...
context master {
    ...
    entity businesspartner {
        key NODE_KEY: common.Guid @(title : 'Partner ID');
        BP_ROLE: String(2);
        ...
        BP_ID: String(32);
        COMPANY_NAME: String(250) @(title : '{i18n>CompanyName}');
    }
...
context transaction {
    entity purchaseorder: cuid,common.Amount{
        // key NODE_KEY: common.Guid @(title : 'Node Key');
        PO_ID: String(40) @(title : '{i18n>PoId}');
        PARTNER_GUID: Association to master.businesspartner;
        LIFECYCLE_STATUS: String(1);
        OVERALL_STATUS: String(1)@(title : 'Status');
